...
{
    [super viewDidLoad];
    self.eventName = [[NSArray alloc]
                     initWithObjects:@"Event A",
                                     @"Event B",
                                     @"Event C",nil];
    
    
    self.eventDate = [[NSArray alloc]
...
{
    return [self.eventDate objectAtIndex:section];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Configure the cell...
    cell.eventNameLabel.text = [self.eventName
